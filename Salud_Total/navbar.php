...
<html lang="es">
  ...
  <body>
    ...
    <div class="container-fluid">
        <a class="navbar-brand"> <h4 class="fw-bold mb-0 fs-3">SALUD TOTAL</h4></a>
        <button
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav">
            ...
            <a class="nav-link" href="historial_clinico.php">Historial Clinico</a>
            <a class="nav-link" href="administracion.php">Administración</a>
          </div>    
            <div class="d-flex justify-content-end ">
              <a href="#" class="btn btn-light">
               <i class="bi bi-person-arms-up"></i><?= $_SESSION["nombre_usuario"] ?? "Invitado"; ?>
              </a>
            </div>
        </div>
        <div class="d-flex justify-content-end">
